    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
            ...
            <div className="w-full max-w-md p-8 space-y-8 bg-white rounded shadow-md">
                <h2 className="text-2xl font-bold font-sans text-center">Register a new account</h2>
                ...
                <div className = "flex flex-col items-center justify-center font-sans font-bold">
                    <p className="text-sm text-center">
                        ...
                        <a href="/login" className="font-medium text-black-600 hover:text-indigo-500 underline">
                            Login
                        </a>
                    </p>
                </div>
